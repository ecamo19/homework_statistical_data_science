...
```
```{r}
plot(best_subset_sel_summary$cp ,xlab =" Number of Variables ", ylab =" Cp",type="l")
which.min(best_subset_sel_summary$cp)
points(17,best_subset_sel_summary$cp[17], col ="red", cex =2, pch =20)


plot(best_subset_sel_summary$bic,xlab =" Number of Variables ", ylab =" BIC ",type="l") 
points (which.min(best_subset_sel_summary$bic),
        best_subset_sel_summary$bic[which.min(best_subset_sel_summary$bic)], 
